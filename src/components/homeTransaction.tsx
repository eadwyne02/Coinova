    ...
    return(
        ...
        <div className="flex items-center justify-around">
          <button onClick={() => navigate("/deposit")}  className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[11px] md:text-[12px] text-white/45 font-medium">Deposit</span>
          </button>
          <button onClick={() => navigate("/sell")} className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[11px] md:text-[12px] text-white/45 font-medium">Sell Crypto</span>
          </button>
          <button onClick={() => navigate("/send")} className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[11px] md:text-[12px] text-white/45 font-medium">Send Crypto</span>
          </button>
